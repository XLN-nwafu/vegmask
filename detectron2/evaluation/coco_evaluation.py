...
class COCOEvaluator(DatasetEvaluator):
    ...
    def _derive_coco_results(self, coco_eval, iou_type, class_names=None):
        ...
        table = tabulate(
            ...
            # headers50=["category", "AP50"] * (N_COLS // 2),
            # headers75=["category", "AP75"] * (N_COLS // 2),
            numalign="left",
        )
        ...
        # results.update({"AP75-" + name: ap for name, ap in results_per_category})
        return results
...
#     print("plot: ",plot)
#     if plot:
#         from detectron2.confusion_matrix import ConfusionMatrix,xywh2xyxy,process_batch,ap_per_class
