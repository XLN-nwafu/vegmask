...
# DCT-mask
# _C.MODEL.ROI_MASK_HEAD.DCT_VECTOR_DIM = 300
# _C.MODEL.ROI_MASK_HEAD.MASK_SIZE = 128
# _C.MODEL.ROI_MASK_HEAD.DCT_LOSS_TYPE = "l1"
# _C.MODEL.ROI_MASK_HEAD.MASK_LOSS_PARA = 1.0

# patchdct
_C.MODEL.ROI_MASK_HEAD.IN_FEATURES = ["p2", "p3", "p4", "p5"]
_C.MODEL.ROI_MASK_HEAD.PATCH_THRESHOLD = 0.30
_C.MODEL.ROI_MASK_HEAD.HIDDEN_FEATURES = 1024
_C.MODEL.ROI_MASK_HEAD.DCT_VECTOR_DIM = 300
_C.MODEL.ROI_MASK_HEAD.MASK_SIZE = 128
_C.MODEL.ROI_MASK_HEAD.DCT_LOSS_TYPE = "l1"
_C.MODEL.ROI_MASK_HEAD.MASK_LOSS_PARA = 1.0
_C.MODEL.ROI_MASK_HEAD.FINE_FEATURES = ["p2"]
_C.MODEL.ROI_MASK_HEAD.FINE_FEATURES_RESOLUTION = 42
_C.MODEL.ROI_MASK_HEAD.MASK_SIZE_ASSEMBLE = 112
_C.MODEL.ROI_MASK_HEAD.PATCH_SIZE = 8
_C.MODEL.ROI_MASK_HEAD.PATCH_DCT_VECTOR_DIM = 6
_C.MODEL.ROI_MASK_HEAD.NUM_STAGE = 2
_C.MODEL.ROI_MASK_HEAD.MASK_LOSS_PARA_EACH_STAGE = [1.0, 1.0]
_C.MODEL.ROI_MASK_HEAD.EVAL_GT = False

# # dy-head
# _C.MODEL.DYHEAD = CN()
# # the number of convolutions used in the cls and bbox tower
# _C.MODEL.DYHEAD.NUM_CONVS = 6
# # the channels of convolutions used in the cls and bbox tower
# _C.MODEL.DYHEAD.CHANNELS = 256
...
_C.MODEL.RETINANET.NUM_CLASSES = 69
...
_C.MODEL.EFFICIENTNET.OUT_FEATURES = ["res2", "res3", "res4", "res5"]
